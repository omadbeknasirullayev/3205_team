...
let User = (() => {
    ...
    var User = _classThis = class {
        constructor() {
            ...
            this.number = (__runInitializers(this, _email_extraInitializers), __runInitializers(this, _number_initializers, void 0));
    ...
    (() => {
        ...
        _email_decorators = [(0, typeorm_1.Column)({ type: 'varchar' })];
        _number_decorators = [(0, typeorm_1.Column)({ type: "varchar" })];
